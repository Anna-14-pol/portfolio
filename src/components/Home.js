  ...
  return (
    <main>
      <img
        src={image}
        alt="Garden"
        className="absolute rounded-br-full rounded-tr-full sm:rounded-r-none object-scale-down sm:object-cover w-fit md:w-full h-full bg-gradient-to-r from-green-600 to-slate-800"
      />
